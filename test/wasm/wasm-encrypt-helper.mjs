...
export function decryptServerResponse(text) {
  let e, t;
  try {
    const l = Dn.__wbindgen_add_to_stack_pointer(-16);
    const g = Xx(text, Dn.__wbindgen_export2, Dn.__wbindgen_export3);
    const c = sg;
    Dn.decrypt_server_response(l, g, c);
    const i = ss().getInt32(l + 0, true), n = ss().getInt32(l + 4, true);
    const r = ss().getInt32(l + 8, true), o = ss().getInt32(l + 12, true);
    let s = i, a = n;
    if (o) { s = 0; a = 0; throw Gb(r); }
    e = s; t = a;
    return ZS(s, a);
  } finally { Dn.__wbindgen_add_to_stack_pointer(16); }
}
export function modelCacheDecrypt(inputText, keyText) {
  let t, i;
  try {
    const g = Dn.__wbindgen_add_to_stack_pointer(-16);
    const c = Xx(inputText, Dn.__wbindgen_export2, Dn.__wbindgen_export3);
    const B = sg;
...
export function credentialStorageDecrypt(payload, keyText) {
  ...
  try {
    ...
    const Q = Xx(keyText, Dn.__wbindgen_export2, Dn.__wbindgen_export3);
    const E = sg;
    Dn.credential_storage_decrypt(g, c, B, Q, E);
    const n = ss().getInt32(g + 0, true), r = ss().getInt32(g + 4, true);
    const o = ss().getInt32(g + 8, true), s = ss().getInt32(g + 12, true);
    let a = n, l = r;
    if (s) { a = 0; l = 0; throw Gb(o); }
